        ...
        for y in range(len(input)):
            if x != y:
                if input[x] + input[y] == 2020:
                    print '%s + %s = %s' %(input[x], input[y], input[x] + input[y])
                    print '%s * %s = %s' %(input[x], input[y], input[x] * input[y])
            ...
            for z in range(len(input)):
                if x != y and x != z and y != z:
                    if input[x] + input[y] + input[z] == 2020:
                        print '%s + %s + %s = %s' %(input[x], input[y], input[z], input[x] + input[y] + input[z])
                        print '%s * %s * %s = %s' %(input[x], input[y], input[z], input[x] * input[y] * input[z])
                        return input[x] * input[y] * input[z]

print 'the answer to part 1 is %s' %(part1(input))
print 'the answer to part 2 is %s' %(part2(input))
